...
public class GenConstants {
     ...
     * 树表（增删改查）
     */
    public static final String TPC_TREE = "tree";
    /**
     * 主子表（增删改查）
     */
     ...
     * 数据库时间类型
     */
    public static final String[] COLUMNTYPE_TIME = {"datatime", "time", "date", "timestamp"};
    /**
     * 数据库数字类型
     */
    ...
    public static final String HTML_TEXTARE = "textarea";
